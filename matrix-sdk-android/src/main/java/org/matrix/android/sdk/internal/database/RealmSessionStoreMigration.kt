...
class RealmSessionStoreMigration @Inject constructor() : RealmMigration {
    ...
    private fun migrateTo5(realm: DynamicRealm) {
        ...
        // Add RawCacheEntity
        realm.schema.create("RawCacheEntity")
                .addField(RawCacheEntityFields.URL, String::class.java)
                .addPrimaryKey(RawCacheEntityFields.URL)
                .setRequired(RawCacheEntityFields.URL, true)
                .addField(RawCacheEntityFields.DATA, String::class.java)
                .setRequired(RawCacheEntityFields.DATA, true)
                .addField(RawCacheEntityFields.LAST_UPDATED_TIMESTAMP, Long::class.java)
    }
}
