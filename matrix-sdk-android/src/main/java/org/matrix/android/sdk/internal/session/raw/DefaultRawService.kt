...
package org.matrix.android.sdk.internal.session.raw

import org.matrix.android.sdk.api.MatrixCallback
import org.matrix.android.sdk.api.session.raw.RawCacheStrategy
...
internal class DefaultRawService @Inject constructor(
    ...
    override fun getWellknown(matrixCallback: MatrixCallback<String>): Cancelable {
